...
class PlacementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create placement" do
    assert_difference("Placement.count") do
      post placements_url, params: { placement: { classroom_id: @placement.classroom_id, person_id: @placement.person_id } }
    end
  ...
  test "should update placement" do
    patch placement_url(@placement), params: { placement: { classroom_id: @placement.classroom_id, person_id: @placement.person_id } }
