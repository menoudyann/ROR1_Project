...
class HistoricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create historic" do
    assert_difference("Historic.count") do
      post historics_url, params: { historic: { class_name: @historic.class_name, end_date: @historic.end_date, people_id: @historic.people_id, start_date: @historic.start_date, status: @historic.status } }
    end
  ...
  test "should update historic" do
    patch historic_url(@historic), params: { historic: { class_name: @historic.class_name, end_date: @historic.end_date, people_id: @historic.people_id, start_date: @historic.start_date, status: @historic.status } }
